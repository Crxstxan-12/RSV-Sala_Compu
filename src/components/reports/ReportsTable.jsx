              ...
              <thead>
                <tr>
                  <th className="sortable" onClick={() => toggleSort('nombre')}>
                    Profesor {sortIcon('nombre')}
                  </th>
                  <th className="sortable" onClick={() => toggleSort('curso')}>
                    Curso {sortIcon('curso')}
                  </th>
                  <th className="sortable" onClick={() => toggleSort('fecha')}>
          ...
          <div className="report-mobile-cards">
            {filas.map(r => (
              <div key={r.id} className="reserva-card">
                ...
                <div className="card-row">
                  <span className="card-label">{tab === 'reservas' ? 'Motivo' : 'Recurso'}</span>
                  <span>{tab === 'reservas' ? r.motivo : r.recurso}</span>
                </div>
                <div className="card-row">
                  <span className="card-label">Estado</span>
                  <span className={getBadgeClass(r.estado)}>{r.estado?.toUpperCase()}</span>
                </div>
              </div>
            ))}
          </div>
